...

{
  ...
  outputs =
    ...
    in
    {
      ...
      nixosConfigurations.binarylane1 =
        nixpkgs.lib.nixosSystem {
          system = "x86_64-linux";
          specialArgs = {inherit pkgs unstable;};
          modules = [
            # Hardware and networking configuration generated by nixos-infect on deploy, not commited to repo
            ...
            ({pkgs, ...}: {
              networking.hostName = "rowan-binarylane1";
